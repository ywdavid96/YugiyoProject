      ...
      <li><button id="join" style="background:#FD7200; width:150px; margin-right:400px;"><a href="#">주문표</a></button></li>
            ...
            <div class="main">
                <div class="site1">
                    ...
                    <input id="form_box" type = "text" class = "int" maxlength = "20" title = "아이디 입력" placeholder = " 아이디를 입력해 주세요"  name="CustomerId">
                </div>
                <div class="site2">
                  <div class="main_3 main_common">비밀번호</div>
                    <input id="form_box" type = "password" class = "int" maxlength = "20" title = "비밀번호 입력" placeholder = " 비밀번호를 입력해 주세요" name="password">
                    </div>
                    </div>
