...
<form action="menuInsert.do" method="get" name="menuInfo">
			<ul>
				<li>
					<input type="text" name="MenuID" placeholder="MENU ID" required><br><br>
				</li>
				<li>
					<input type="text" name="MBoardID" placeholder="MBOARD ID" required><br><br>
				</li>
				<li>
