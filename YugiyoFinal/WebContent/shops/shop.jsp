...
<header class="login">
	...
	<header class="Brand">
		<div class="menubar">
			<ul>
				<li><a class="active" href="../foods/allmenu.jsp">전체보기&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
				...
				<li><a href="../foods/japanesefood.jsp">일식/돈까스&nbsp;&nbsp;&nbsp;&nbsp;</a></li>
...
ResultSet rs2 = service.getMenu(ShopId);
...
ResultSet rs3 = service.getReview(ShopId);
