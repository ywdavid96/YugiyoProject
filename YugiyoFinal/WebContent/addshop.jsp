...
<div class="clear"></div>
<header class="head"><p class="normal" style="color:white; font-weight:bold; font-size:25px">&nbsp;&nbsp;음식점의 정보를 기입해주세요</p></header>

<form action="shopInsert.do" method="get">
			<ul>
				<li>
					<input type="text" name="ShopId" placeholder="SHOP ID" required>
				</li>
				<li>
				...
				<li>
					<input type="text" name="reqprice" placeholder=" REQPRICE" required>
				</li>
				<li>
					<input type="text" name="payment" placeholder=" PAYMENT" required><br><br><br>
				</li>
				<li>
				...
				<li>
					<input type="text" name="availTime" placeholder=" AVAILTIME" required>
				</li>
				<li>
					<input type="text" name="reputation" placeholder=" REPUTATION" required>
				</li>
				<li>
